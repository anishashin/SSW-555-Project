...
class Test(unittest.TestCase):
    ...
    def test01(self):
        ...
        self.assertEqual(us01DatesBeforeCurrentDate('27 AUG 2020', 'US0102101521_F01', 'FAMILY', 'Divorce date'), 'ERROR: ' + 'FAMILY' + ': US01: ' + 'US0102101521_F01' + ': ' + 'Divorce date' + ' ' + '2020-08-27' + ' occurs in the future')
    ...
    def test02(self):
        self.assertEqual(us02BirthBeforeMarriage('23 MAY 2020', 'US0102101521_F01'), ['ERROR: FAMILY: US02: ' + 'US0102101521_F01' + ": Husband's birth date " + '2094-03-01' + ' after marriage date ' + '2020-05-23', 'ERROR: FAMILY: US02: ' + 'US0102101521_F01' + ": Wife's birth date " + '2021-08-02' + ' after marriage date ' + '2020-05-23'])
    ...
    def test15(self):
        self.assertEqual(us15FewerThan15Siblings('US0102101521_F01'), 'ERROR: FAMILY: US15: US0102101521_F01: There are 15 siblings or more in family')
    ...
    def test16(self):
        self.assertEqual(us16MaleLastNames('US0102101521_F01'), [])
