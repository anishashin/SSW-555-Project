...
class Test(unittest.TestCase):
    ...
    def test02(self):
        self.assertEqual(us02BirthBeforeMarriage('23 MAY 2020', 'US01US02_F01'), ['ERROR: FAMILY: US02: ' + 'US01US02_F01' + ": Husband's birth date " + '2094-03-01' + ' after marriage date ' + '2020-05-23'])
        self.assertEqual(us02BirthBeforeMarriage('23 MAY 2020', 'US01US02_F01'), ['ERROR: FAMILY: US02: ' + 'US01US02_F01' + ": Wife's birth date " + '2021-08-02' + ' after marriage date ' + '2020-05-23'])
